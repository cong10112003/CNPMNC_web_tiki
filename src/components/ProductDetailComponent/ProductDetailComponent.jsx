...
import imageProduct from "../../Assets/Image/imageProduct.jpg";
import imageProductSmall from "../../Assets/Image/imageProductSmall.jpg";
import {
      ...
      <Col span={14} style={{paddingLeft: '10px'}}>
        ...
        <div>
          ...
          <StarFilled
            style={{ fontSize: "12px", color: "rgb(253, 216, 54)" }}
          />
          <WrapperTextSell>| Đã bán 5000+</WrapperTextSell>
        </div>
